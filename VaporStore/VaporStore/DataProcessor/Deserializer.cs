namespace VaporStore.DataProcessor
{
    ...
    public static class Deserializer
    {
        ...
        public static string ImportPurchases(VaporStoreDbContext context, string xmlString)
        {
            ...
            ImportPurchaseDto[] importPurchaseDtos = (ImportPurchaseDto[])xmlSerializer.Deserialize(reader);
            ...
            foreach (ImportPurchaseDto purchaseDto in importPurchaseDtos)
            {
                ...
                object purchaseTypeObject;
                bool HasPurchaseValidType = Enum.TryParse(typeof(PurchaseType), purchaseDto.Type, out purchaseTypeObject);

                if (!HasPurchaseValidType)
                {
                    sb.AppendLine(ErrorMessage);
                    continue;
                }

                PurchaseType purchaseType = (PurchaseType)purchaseTypeObject;
