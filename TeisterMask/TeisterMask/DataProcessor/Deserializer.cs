...
namespace TeisterMask.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportProjects(TeisterMaskContext context, string xmlString)
        {
            ...
            ImportProjectDto[] importProjectDtos = (ImportProjectDto[])xmlSerializer.Deserialize(reader);
            ...
            foreach (ImportProjectDto projectDto in importProjectDtos)
            {
                ...
                {
                    DateTime dueDateInterim;
                    bool isDueDateValid = DateTime.TryParseExact(projectDto.DueDate, "dd/MM/yyyy",
                        CultureInfo.InvariantCulture, DateTimeStyles.None, out dueDateInterim);
